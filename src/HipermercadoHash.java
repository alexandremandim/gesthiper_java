...
import java.util.*;
import java.io.*;
public class HipermercadoHash implements Serializable
{
    private CatalogoClientesHash clientes;
    private CatalogoProdutosHash produtos;
    private ComprasHash compras;
    private ArrayList<String> linhasComprasInvalidas;
    private ContabilidadeHash contabilidade;
    private String ultimoFileComprasLido, fileProdutos, fileClientes;
    
    /* construtores */
    public HipermercadoHash()
    {
        this.clientes = new CatalogoClientesHash();
        this.produtos = new CatalogoProdutosHash();
        this.compras = new ComprasHash();
        this.linhasComprasInvalidas = new ArrayList<String>();
        this.contabilidade = new ContabilidadeHash();
        this.ultimoFileComprasLido = new String();
        this.fileProdutos = new String();
        this.fileClientes = new String();
    }
    public HipermercadoHash(HipermercadoHash hiper){
    ...
    /* gets */
    CatalogoClientesHash getClientes(){return this.clientes.clone();}
    CatalogoProdutosHash getProdutos(){return this.produtos.clone();}
    ComprasHash getCompras(){return this.compras.clone();}
    ...
    ContabilidadeHash getContabilidade(){return this.contabilidade.clone();}
    ...
    public int nrComprasGratuitas(){return this.compras.getComprasNulas();} // ComprasHash com preco igual a 0
    // 1.2
    ...
    //Query3
    // dado 1 mes determinar o nr total de ComprasHash realizadas e o nr clientes distintos q a realizaram
    ...
    public HipermercadoHash clone(){
        return new HipermercadoHash(this);
    }
    ...
    public boolean equals(Object o){
        ...
        HipermercadoHash hiper = (HipermercadoHash)o;
