...
public class ComprasHash implements Serializable
{
    ...
    public ComprasHash()
    {
        this.compras = new HashMap<String,Map<String,RegistoCompra>>();
        this.comprasNulas = 0;
    }
    public ComprasHash(ComprasHash c)
    {
    ...
    public Map<String,Map<String,RegistoCompra>> getCompras(){
        Map<String,Map<String,RegistoCompra>> novo = new HashMap<String,Map<String,RegistoCompra>>();
        
        for(String cod_cli: this.compras.keySet()){
            Map<String,RegistoCompra> novo_in = new HashMap<String,RegistoCompra>();
    ...
    public void addCompra(String codigoCliente, double preco, int quantidade, char modo, String codigoProduto, int mes){
        ...
        if(this.compras.containsKey(codigoCliente)){    // ja tem cod cliente
            ...
            Map<String,RegistoCompra> novoTreeProdutos = new HashMap<String,RegistoCompra>();   // criar treeProdutos
    ...
    public Set<String> listaClientesQRealizaramCompras(){
        Set<String> clientesQCompraram = new HashSet<String>();
    ...
    throws ClienteSemComprasException{
        Map <Integer,TrioCompsEProdDistETotalGasto> resultado = new HashMap <Integer,TrioCompsEProdDistETotalGasto> ();
        for(int i = 1;i<=12; i++){
    ...
    public Map<Integer,TrioXsCompradoENrCliEFaturado> xsCompradoClientesEFaturado(String codigoProduto){
        Map <Integer,TrioXsCompradoENrCliEFaturado> resultado = new HashMap <Integer,TrioXsCompradoENrCliEFaturado> ();
        for(int i = 1;i<=12; i++){
    ...
    public Set<TrioProdutosUnidadesClientes> produtosMaisVendidos(){
        Map<String,TrioProdutosUnidadesClientes> todosProdutos = new HashMap<String,TrioProdutosUnidadesClientes>();
    ...
    public int hashCode(){
        return Arrays.hashCode(new Object[] {this.getCompras(),this.getComprasNulas()});
    }
    
    // clone, equals, toString
    public ComprasHash clone(){
        return new ComprasHash(this);
    }
    ...
    public boolean equals(Object o){
        ...
        ComprasHash comp = (ComprasHash)o;
